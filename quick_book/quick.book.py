...
# def limit():
#     # 2021-11-20 00:00 我是
#     # pyinstaller.exe -F -p venv/Lib/site-packages/ quick.book.py
...
# data = '------WebKitFormBoundary7MA4YWxkTrZu0gW\r\nContent-Disposition: form-data; name="son"\r\n\r\nZ7LJ2/WX\r\n------WebKitFormBoundary7MA4YWxkTrZu0gW\r\nContent-Disposition: form-data; name="pcc"\r\n\r\n7LJ2\r\n------WebKitFormBoundary7MA4YWxkTrZu0gW\r\nContent-Disposition: form-data; name="pwd"\r\n\r\nLLP0605\r\n------WebKitFormBoundary7MA4YWxkTrZu0gW\r\nContent-Disposition: form-data; name="gds"\r\n\r\nGalileo\r\n------WebKitFormBoundary7MA4YWxkTrZu0gW--'
# content = \
#     (
...
#         "Origin: https://webagentapp.tts.com\r\n"
#         "Referer: https://webagentapp.tts.com/\r\n"
...
_thread.start_new_thread(dorecv, (sock,) )
...
#             elem.write_count += 1
#             if elem.write_count >= 5 :     # 如果经过了30次的select轮询，依旧没有连接成功，则说明连接出现了问题。关闭此连接
#                 elem.sock.close()
...
#
#
# def get_object_login():
#     return {
#         "type": "login",
#         "host": "webagentapp.tts.com",
#         "url": "/TWS/Login",
#         # "data": "son=Z7LJ2/WX&pcc=7LJ2&pwd=LLP0605&gds=Galileo",
#         'data': '------WebKitFormBoundary7MA4YWxkTrZu0gW\r\nContent-Disposition: form-data; name="son"\r\n\r\nZ7LJ2/WX\r\n------WebKitFormBoundary7MA4YWxkTrZu0gW\r\nContent-Disposition: form-data; name="pcc"\r\n\r\n7LJ2\r\n------WebKitFormBoundary7MA4YWxkTrZu0gW\r\nContent-Disposition: form-data; name="pwd"\r\n\r\nLLP0605\r\n------WebKitFormBoundary7MA4YWxkTrZu0gW\r\nContent-Disposition: form-data; name="gds"\r\n\r\nGalileo\r\n------WebKitFormBoundary7MA4YWxkTrZu0gW--',
#         "callback": callback
#     }
#
